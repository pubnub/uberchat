/*
NOTE: This is just a copy of /wp-srv/analytics/omniture.js .
When you need to test, edit this file, verify it works and put it into main.js
NOTE: virtual includes not working.
<!--"HASH"include virtual="/wp-srv/analytics/omniture.js"-->
*/
...
*/
    ...
    s.prop72 = ( !! window.localStorage && !! localStorage.opbandit && localStorage.opbandit == 'D') ? 'eligible' : 'ineligible';
    if (!window.wp_pvid) {
...
s.nullifyOnResend = ['events', 'campaign', 'prop20', 'prop27', 'prop71', 'eVar3', 'eVar13', 'eVar20', 'eVar71'];
...
if (typeof _suppressTrackPageLoad == 'undefined' || !_suppressTrackPageLoad) {
    if (window.TWP &&
        ...
        $(window.document).on("onTwpMeterComplete", function(event) {
